...
public class App 
{
	...
	*/
    public static void main( String[] args )
    {
		...
		System.out.println("Applying bitwise OR results in " + binOr.getValue());
		Binary binAnd=Binary.and(binary1, binary2);
		System.out.println("Applying bitwise and results in " + binAnd.getValue());
		Binary binMult=Binary.multiply(binary1, binary2);
		System.out.println("Multiplying them results in " + binMult.getValue());
    }
}